...
function validate() {
	return isValidUserInfo() && isValidAccountInfo();
}
...
function isValidUserInfo() {
	isValid = true;
	isValid = isEmptyValidator($("#username")) && isValid;
	isValid = isEmptyValidator($("#password")) && isValid;
	isValid = isEqualValidator($("#confirm"), $("#password")) && isValid;
	if ($("#individual").is(":checked")) {
		isValid = isEmptyValidator($("#firstname")) && isValid;
		isValid = isEmptyValidator($("#lastname")) && isValid;
		isValid = isEmptyValidator($("#socialsecurity")) && isValid;
		isValid = isValidDate($("#dateofbirth")) && isValid;
	} else {
		isValid = isEmptyValidator($("#companyname")) && isValid;
	}
	isValid = isEmptyValidator($("#email")) && isValid;
